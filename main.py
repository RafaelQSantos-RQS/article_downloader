...
extract_pmcid_from_list(list_of_pubmed=list_of_pubmed,number_of_webscrappers=8,headless=True,save_in='./data/processed')

# Baixando os artigos
info("## BAIXANDO OS ARTIGOS ##")
list_of_pmcid = set(pd.read_csv('data/processed/pubmed_vs_pmcid.csv')['pmcid'].dropna(axis=0))
download_articles_from_list_of_pmcid(list_of_pmcid=list_of_pmcid,headless=True,save_in='data/raw/articles',max_workers=8)